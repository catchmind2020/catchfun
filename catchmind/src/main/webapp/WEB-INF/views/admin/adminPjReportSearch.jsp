            ...
            <br><br>
	          	<div id="pagingArea">
			        <ul class="pagination">
			             ...
			             <c:otherwise>
			            		<li class="page-item"><a class="page-link" href="prSearch.ad?currentPage=${ pi.currentPage-1 }">Previous</a></li>
			            	</c:otherwise>
			            </c:choose>
			            ...
			            <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
			            	<c:choose>
			             	...
			             	<c:otherwise>
			             		<li class="page-item"><a class="page-link" href="prSearch.ad?currentPage=${ p }">${ p }</a></li>
			            		</c:otherwise>
			            	</c:choose>
			            </c:forEach>
			            ...
			            <c:choose>
			             ...
			             <c:otherwise>
			             	<li class="page-item"><a class="page-link" href="prSearch.ad?currentPage=${ pi.currentPage+1 }">Next</a></li>
			            	</c:otherwise>
			            </c:choose>
			        </ul>
			    </div>
