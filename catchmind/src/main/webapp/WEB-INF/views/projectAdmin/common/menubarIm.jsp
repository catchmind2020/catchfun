...
<link
	href="<%=contextPath%>/resources/admin/vendor/fontawesome-free/css/all.min.css"
...
<link href="<%=contextPath%>/resources/admin/css/sb-admin-2.css"
	rel="stylesheet">
...
<body id="page-top">
	...
	<ul
		...
		id="accordionSidebar" style="float: left;">
		...
		<li class="nav-item active"><a class="nav-link" href="#">
				<div align="center">
					<svg class="bi bi-people-circle" width="2em" height="2em"
              ...
              <path fill-rule="evenodd"
							d="M8 9a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" />
              <path fill-rule="evenodd"
		...
		<li class="nav-item active"><a class="nav-link"
			href="<%=contextPath%>/home.pa"> <span>Home</span></a></li>
		...
		<li class="nav-item"><c:choose>
				...
				<c:otherwise>
					...
					<a class="nav-link collapsed" href="<%=contextPath%>/home.pa"
						...
						class="fas fa-fw fa-user"></i> <span>펀딩준비</span>
					</a>
				</c:otherwise>
			</c:choose>
		...
		<li class="nav-item"><c:choose>
				...
				<c:otherwise>
					<a class="nav-link collapsed"> <i class="fas fa-fw fa-list"></i>
						<span>내펀딩(잠김)</span>
					</a>
			...
			<div id="collapsePages" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					<a class="collapse-item"
						href="<%=contextPath%>/fund.pa?currentPage=1">펀딩현황</a> <a
						class="collapse-item"
						href="<%=contextPath%>/news.pa?currentPage=1">새소식</a>
				</div>
			</div></li>
	...
	<!-- Page level plugins -->
	<script
		src="<%=contextPath%>/resources/admin/vendor/chart.js/Chart.min.js"></script>

	<!-- Page level custom scripts -->
	<script
		src="<%=contextPath%>/resources/admin/js/demo/chart-area-demo.js"></script>
	<script
		src="<%=contextPath%>/resources/admin/js/demo/chart-pie-demo.js"></script>
