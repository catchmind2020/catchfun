  ...
  <div class="card shadow mb-4" style="width: 1000px; ">
                ...
                <div class="card-body">
                 <fieldset style="color: black; font-size: 15px;">
						...
						<input name="checka1" type="radio" class="q1_type" value="현장결제"
							id="agree2" checked="checked"> <label for="pay_type_1">아니요.
							다른 곳에서 유통한 적이 없으며 와디즈를 통해 처음 선보이는 제품입니다.</label>
							<br> <input name="checka1" type="radio" class="q1_type" value="신용카드"
							id="agree"> <label for="pay_type_2">예, 다른 곳에서 유통한
				...
				<div id="area1" style="display: none">
					...
					<textarea id="question1" name="question1" class="questiontext"></textarea>
                ...
                <div class="card-body black" style="line-height:225%;" >
             		   <input name="checka2" type="radio" class="q2_type" 
							id="agree3" checked="checked"> 금형을 이용하여 제작되는 리워드이며, 메이커가 아이디어 단계부터 리워드의 기획 및 개발, 생산까지의 전 과정을 담당합니다.<br>
						...
						<input name="checka2" type="radio" class="q2_type" id="agree4"> 금형을 이용하여제작되는 리워드이며, 메이커가 아이디어 단계부터 직접 기획 및 개발한 제품이지만
			...
			<div class="card shadow mb-4" style="width: 1000px;">
                ...
                <div class="card-body">
							...
							<textarea id="question2" name="question2" class="questiontext"
								required></textarea>
                </div>
            </div>
...
$(function(){
	...
	function withdrawalMember(){ //탈퇴버튼 클릭시
		var uNo = new Array();
		
		$("input[name=uNo]:checked").each(function(){
			uNo.push($(this).val());
		...
		if(uNo == ""){
			...
			if(confirm("탈퇴 처리하시겠습니까?")){
				$.ajax({
					url:"<%=contextPath%>/reportMemWithdrawal.ad",
					dataType:"json",
					data:{uNo:uNo}, // uNo을 uNo으로 선언
					type:"post",
					success:function(result){
						alert(result.msg);
						location.href="<%=contextPath%>/memberList.ad?currentPage=1";
					},
					error:function(){
