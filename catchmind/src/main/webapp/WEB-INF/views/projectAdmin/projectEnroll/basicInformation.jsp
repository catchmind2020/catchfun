...
<c:if test="${ ProjectBasic.check1 eq q1c1 }">
	<c:set var="q1ch1" value="checked='true1'" />
	${ q1ch1 }
</c:if>
<c:if test="${ ProjectBasic1.check1 eq q1c2 }">
...
<c:choose>
	...
	<div class="outer">
		<form style="margin-left: 270px;" action="insertBasic.pa" method="post">
			<div style=" height: 700px;">
				<br>
				<h1 class="h3 text-gray-900 mb-4">기본 요건</h1>
				<h1 style="color: black; font-size: 15px;">펀딩 진행을 위한 기본 요건을 확인하고자
					합니다. 심사 시 확인하는 중요한 정보이므로 반드시 정확한 정보를 입력하세요. 답변 내용이 사실과 다른 경우,<br> 약정
					위반에 따른 불이익이 발생할 수 있습니다.</h1>

			
  <div class="card shadow mb-4" style="width: 1000px; ">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"> Q1. 리워드가 타 크라우드 펀딩사 및 온라인 커머스, 자사홈페이지등 다른
					판매처에서 유통된 적이 있거나 현재 유통중인가요?</h6>
                </div>
                <div class="card-body">
                 <fieldset style="color: black; font-size: 15px;">
						...
						<input name="check1" type="radio" class="q1_type" value="q1c1"
							...
							다른 곳에서 유통한 적이 없으며 와디즈를 통해 처음 선보이는 제품입니다.</label>
							<br> <input name="check1" type="radio" class="q1_type" value="q1c2"
							id="agree" ${q1ch2}> <label for="pay_type_2">예, 다른 곳에서 유통한
							적이 있습니다. 또는 현재 유통 중입니다.</label>
				...
				<div class="card shadow mb-4" style="width: 1000px;" >
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Q2. 리워드가 금형을 이용하여 제작되는 제품인지 확인하고 리워드에 맞는 제조
					형태를 선택해주세요</h6><br>
					<h1 class="grey">※ 금형을 이용하지 않고 제작되는 리워드라면 다섯번째 답변을 선택해주세요.<br> ※ 제조 형태에 따라 필요한 서류는 반드시 아래 리워드 필수 인증 서류 항목에 업로드해주세요.</h1>
                </div>
                
                <div class="card-body black" style="line-height:225%;" >
             		   <input name="check2" type="radio" class="q2_type" id="agree3" value="q2c1" checked="${q2ch1}"> 금형을 이용하여 제작되는 리워드이며, 메이커가 아이디어 단계부터 리워드의 기획 및 개발, 생산까지의 전 과정을 담당합니다.<br>
						...
						<input name="check2" type="radio" class="q2_type" id="agree4" value="q2c2" ${q2ch2}> 금형을 이용하여제작되는 리워드이며, 메이커가 아이디어 단계부터 직접 기획 및 개발한 제품이지만
						, 제품의 양산 등의<br> 과정은 메이커가 아닌 위탁 생산 업체가 담당합니다.<br>
						...
						<input name="check2" type="radio" class="q2_type" id="agree5" value="q2c3" ${q2ch3}> 금형을 이용하여
							제작되는 리워드이며, 메이커가 국내외 제조업체에서 개발이 완료된 제품의 일부를<br> 개선 혹은 변경한 뒤 자신의 브랜드로
							위탁 생산을 의뢰하였습니다.<br>
						...
						<input name="check2" type="radio" class="q2_type" id="agree6" value="q2c4" ${q2ch4}> 금형 이용 여부와
							관계없이 이미 제작 완료된 해외 브랜드의 제품을 메이커가 국내 첫 단독 총판의 자격으로 수입하여 유통합니다<br>
						...
						<input name="check2" type="radio" class="q2_type" id="agree7" value="q2c5" ${q2ch5}>패션잡화, 디자인
							소품, 화장품, 식품, 서비스 이용권 등 금형을 이용하지 않고 제작되는 리워드입니다.
			...
			<div class="card shadow mb-4" style="width: 1000px;">
                <div class="card-header py-3">
	                  <h6 class="m-0 font-weight-bold text-primary">Q3. 현재까지 진행된 리워드의 준비 상태 및 앞으로의 계획을 구체적으로
						설명해주세요.</h6>
                </div>
                <div class="card-body">
	                 	<h1 class="grey">
						1) 리워드가 유형의 제품인 경우 제작 공정에 따른 현재 리워드의 제작 상태 및 제조 시설명과 일일 최대 생산 가능량을
						포함한 앞으로의 생산 계획을 작성해주세요. <br> 2) 공연, 영화, 전시 등 무형 서비스인 경우, 장소
			...
			<div class="card shadow mb-4" style="width: 1000px;">
                <div class="card-header py-3">
	                  <h6 class="m-0 font-weight-bold text-primary">Q4. 리워드의 전달 계획을 알려주세요.</h6>
                </div>
                <div class="card-body">
	                 		<h1 class="grey">
							1) 리워드의 전달 방법(택배 or SMS 등)을 입력하고, 리워드 제작 및 전달 일정이 변동될 가능성이 있다면 사유를
							알려주세요.<br> 2) 발송 업체명 및 일일 최대 발송 가능량을 입력해주세요.<br> 3) 공연,
							영화, 전시 등 무형 서비스의 경우 좌석수, 일 최대 예약 가능 수량 등을 작성해주세요.
							</h1>
			...
			<div class="card shadow mb-4" style="width: 1000px;">
                ...
                <div class="card-body">
				  ...
				  <div class="custom-control custom-checkbox small">
                        <input name="check3" type="checkbox" class="custom-control-input" id="customCheck" required>
                        <label class="custom-control-label" for="customCheck">와디즈 수수료 정책을 확인하였습니다</label>
                      </div> 
				<br>
				<div class="blacktool" style="display: block">
					오픈예정 서비스란?<br> 프로젝트 오픈에 대하여, 사전에 알림 홍보를 할 수 있는 서비스 페이지를 말합니다.
					프로젝트 펀딩에 관심 있는 예비 서포터들이 펀딩 시작 전에 내용을 둘러 보고, 관심이 있을 경우 알림 신청을 할 수 있는
					페이지입니다.<br> 성공 프로젝트의 경우 평균적으로 오픈 직후 3일 안에 전체 펀딩액의 약 35%를
					모집합니다.<br>
				</div>
				  <div class="custom-control custom-checkbox small">
                        <input name="check4" type="checkbox" class="custom-control-input" id="customCheck2" required>
                        <label class="custom-control-label" for="customCheck2">오픈예정 서비스 신청</label>
                      </div> 
