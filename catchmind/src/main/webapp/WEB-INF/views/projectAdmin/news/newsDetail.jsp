...
<h1 class="h3 text-gray-900 mb-4">스토리등록</h1>
			<form action="updateNews.pa" method="post">
				...
				<div class="card shadow mb-4" style="width: 1000px;">
					...
					<div class="card-body">
						제목:<input class="questiontext" name="newsTitle" value="${news.newsTitle}" required></inputs><br>
						<textarea id="summernote" name="newsContent" required>${news.newsContent}</textarea>
					</div>
				</div>
				...
				<div class="col-auto row">
					...
					&nbsp;&nbsp;&nbsp;
					 	<a href="<%=contextPath%>/deleteNews.pa">
								<button type="button" class="btn btn-primary" style="width: 200px;">삭제하기</button>
						</a>
