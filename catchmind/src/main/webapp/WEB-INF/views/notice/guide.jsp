...
펀딩 참여가 아니더라도 프로젝트를 SNS에 공유해주시거나 댓글을 달아주시면 메이커에게는 정말 큰 힘이 되오니 많은 참여 부탁드립니다.
    ...
    <p class="content">캐치펀에서는 만들고자 하는 창작 아이디어만 있다면 누구나 쉽고 간단하게 프로젝트를 선보일 수 있습니다. <br>
        ...
        작성이 끝나면 검토 요청하기를 선택해 텀블벅 운영팀의 공개 검토를 요청하세요. 공개 검토 결과는 이메일로 안내드립니다.<br>
        ...
        <p class="content">
            ...
            텀블벅 플랫폼 이용 수수료<br>
먼저 텀블벅은 모집이 성사된 프로젝트에 한해 모금액의 5%를 유지비용으로 수수하고 있습니다. <br><br>

텀블벅 플랫폼 수수료는 총 모금액의 5%(VAT 별도)입니다. <br>
...
이는 텀블벅이 창작자의 프로젝트에 대한 후원 결제를 진행하는 데에 발생한 비용을 받아 결제 대행사에 납부하는 비용입니다.<br><br>

세금계산서 발행<br>
텀블벅은 부가가치세법 18조에 의거하여, 모집에 소요된 모든 수수료에 대해 프로젝트 진행자가 비용을 증빙할 수 있도록 전자세금계산서를 발행해드리고 있습니다.
