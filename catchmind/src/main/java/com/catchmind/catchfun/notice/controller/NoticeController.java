...
public class NoticeController {
	...
	public String cqSelectList(int currentPage, Model model) {
	
		
		int listCount = ntService.cqselectListCount();	// 게시판 글갯수 조회용
		PageInfo pi = Pagination.getPageInfo(listCount, currentPage, 10, 5);
		ArrayList<CatchfunQuestion> list = ntService.cqselectList(pi);
	...
	public String insertBoard(CatchfunQuestion q, Model model) {
		
		int result = ntService.insertCatchfunQuestion(q);
